...
parser = argparse.ArgumentParser(
    description="UART Host simulation"
)
...
parser.add_argument(
    ...
    type=str,
    default="An",
    help="Message to transmit (default: An)"
)
...
parser.add_argument(
    ...
    type=int,
    default=0,
    help="Simulation tick at which transmission starts (default: 0)"
)
...
parser.add_argument(
    ...
    type=int,
    default=1700,
    help="Number of ticks between segment transmissions (default: 1700)"
)
...
# TODO: Make segment size configurable after verifying
#       variable segment sizes work correctly.
MAX_SEGMENT_SIZE = 8

TEST_MESSAGE = args.data
...
for segment_index, segment in enumerate(segments):
    ...
    print(
        f"Segment char  : "
        f"{segment.decode('ascii', errors='replace')}"
    )
